...
In experiments, StyleGAN achieves state-of-the-art image fidelity (low Frechet Inception Distance) and more linear, less entangled latent factors than conventional GANs.
...
(no progressive growing, weight demodulation, path regularization) achieves a Frechet Inception Distance of 
