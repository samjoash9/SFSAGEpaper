\subsection{Generative Adevrsarial Networks}
...
The adversarial training process in GANs is governed by a minimax optimization. Formally, \cite{GAN} define the value function:
\begin{align*}
