...
Meta-learning approaches have been applied here: for instance, the FIGR model \citet{clouatre2019figrfewshotimagegeneration} meta-trains a GAN with the Reptile algorithm so it can generate new classes from as few as 4 examples.
