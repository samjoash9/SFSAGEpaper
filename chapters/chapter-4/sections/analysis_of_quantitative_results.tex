...
SFSAGE model compares against AGE and SAGE baselines across the Flowers and Animal Faces datasets at 1024$\times$1024 resolution only using FID and LPIPS metrics.
