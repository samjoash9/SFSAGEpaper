...
\caption{Comparison across AGE, SAGE, and the proposed SFSAGE model under one-shot setting with a different dog input image. Each model generates two outputs per input to illustrate diversity and semantic consistency.}
...
Further, the advantages of SFSAGE are highlighted by Figure \ref{fig:qualitative_input2}. The sharpness in petal edges 
...
Figure \ref{fig:qualitative_input4}, the similar behavior to the third image input for SFSAGE is observed, where it maintains consistency in terms of pose within the results, 
...
noted that SFSAGE is better at maintaining consistency of shape and structure for eyes, thus improving realism. It is also observed that the 
results from SFSAGE have better clarity and contrast, improving image quality, particularly for fur texture and shading. On the other hand, 
