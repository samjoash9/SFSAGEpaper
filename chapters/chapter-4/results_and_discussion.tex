...
performance in high and low resolution settings, the experiments are conducted at 1024x1024 resolution only. 
The quality of the generated images and their perceptual similarity to real images are measured 
using Fr\'echet Inception Distance (FID) and Learned Perceptual Image Patch Similarity (LPIPS), respectively. 
