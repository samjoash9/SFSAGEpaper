...
\begin{enumerate}
    \item Lower FID, reflecting improved visual realism and closer distributional alignment between generated and real images.
    \item Comparable LPIPS, reflecting that improvements in FID should not come from collapsing outputs into overly similar samples.
\end{enumerate}
