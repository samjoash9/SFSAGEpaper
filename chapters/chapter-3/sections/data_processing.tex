...
\begin{enumerate}
    ...
    \begin{figure}[ht]
        ...
        \caption{Sample images from the FUNIT Animal Faces dataset. Source: \citep{liu2019few}}
    ...
    \begin{figure}[ht]
        ...
        \caption{Sample images from 102 Flower Dataset. Source: \citep{Nilsback08}}
        \label{fig:102Flower}
    \end{figure}
