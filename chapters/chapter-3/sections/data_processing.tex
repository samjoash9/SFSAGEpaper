...
\begin{itemize}
    \item Resizing and Normalization: Images will be resized to 256$\times$256 for efficiency (and 512$\times$512 for high-res experiments) and pixel values will be normalized to the range [-1,1] for input to StyleGAN2.
